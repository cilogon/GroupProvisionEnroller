...
// with a self-signup enrollment flow that
...
class GroupProvisionEnrollerCoPetitionsController extends CoPetitionsController {
  // Class name, used by Cake
  public $name = "GroupProvisionEnrollerCoPetitions";
  public $uses = array(
    "CoPetition",
    "GroupProvisionEnroller.GroupProvisionEnroller"
  );
